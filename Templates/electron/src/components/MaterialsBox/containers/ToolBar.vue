...
<!--
 * @Time             : 2021-12-04 00:50:15
 * @Author           : Albert Wang
 * @Email            : shadowofgost@outlook.com
 * @Software         : Vscode
 * @FilePath         : /LiveStream/Templates/electron/src/components/MaterialsBox/containers/ToolBar.vue
 * @Copyright Notice : Copyright 2021 Albert Wang 王子睿, All Rights Reserved.
 * Copyright 2021 Albert Wang 王子睿, All Rights Reserved.
 * @Description      :
 * @LastTime         : 2021-12-04 11:02:06
...
<template>
  <div class="tool-bar">
    <template v-for="(type, typeIndex) in Object.keys(toolMap)" :key="typeIndex">
      <ToolBox :class="type">
        <template v-for="(item, index) in toolMap[type].filter(target => target.enable)" :key="'tool_' + type + '_item_' + index">
          <!-- 颜色 -->
          <ToolItem
