...
<!--
 * @Time             : 2021-12-04 00:50:14
 * @Author           : Albert Wang
 * @Email            : shadowofgost@outlook.com
 * @Software         : Vscode
 * @FilePath         : /LiveStream/Templates/electron/src/components/MaterialsBox/MaterialsSelector.vue
 * @Copyright Notice : Copyright 2021 Albert Wang 王子睿, All Rights Reserved.
 * Copyright 2021 Albert Wang 王子睿, All Rights Reserved.
 * @Description      :
 * @LastTime         : 2021-12-04 11:00:16
...
<template>
  <div class="materials-selector">
    ...
    <div class="category">
      <template v-for="(item, index) in categoryList.filter(target => target.enable)" :key="'category_' + index">
        <div
      ...
      <template v-for="(item, index) in toolList.filter(target => target.enable)" :key="'tool_' + index">
        <div
          class="tool-item"
